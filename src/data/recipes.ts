...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1435904-6923a0a5a8de?w=800&auto=format&fit=crop&q=60",
    cookTime: 25,
    servings: 4,
  ...
  },
  {
    id: "16",
    title: "Dhokla",
    description: "A light and fluffy steamed savory cake made from fermented rice and chickpea flour, a popular Gujarati snack.",
    image: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=800&auto=format&fit=crop&q=60",
    cookTime: 25,
    servings: 4,
    categories: ["Snack", "Indian", "Vegetarian"],
    ingredients: [
    ...
    instructions: [
      "Mix gram flour, rice flour, yogurt, ginger paste, green chili paste, turmeric, and salt.",
      "Add water to make a smooth batter.",
      "Let it rest for 15-20 minutes.",
      "Add fruit salt just before steaming and mix well.",
      "Pour into a greased plate and steam for 15-20 minutes.",
      "For tempering, heat oil and add mustard seeds.",
      "When they crackle, add sesame seeds, curry leaves, and green chilies.",
      "Add water and sugar, let it boil for a minute.",
  ...
  },
  {
    id: "17",
    title: "Pav Bhaji",
    description: "A popular street food dish consisting of a spiced vegetable curry served with soft bread rolls.",
    image: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=800&auto=format&fit=crop&q=60",
    cookTime: 35,
    servings: 4,
    ...
    instructions: [
      ...
      "Add pav bhaji masala, red chili powder, and turmeric.",
      "Add mashed vegetables and mix well.",
      "Cook for 10-15 minutes, mashing occasionally.",
      "Toast pav with butter.",
      "Serve hot with chopped onions, lemon wedges, and coriander."
    ],
    nutrition: {
      calories: "380 kcal",
      protein: "10g",
  ...
  },
  {
    id: "18",
    title: "Vada Pav",
    description: "A popular Mumbai street food consisting of a spicy potato fritter sandwiched in a bun with chutneys.",
    ...
    instructions: [
      ...
      "Shape into patties and deep fry until golden brown.",
      "For green chutney, blend all ingredients to a smooth paste.",
      "For dry chutney, grind all ingredients to a coarse powder.",
      "Slit the pav and spread both chutneys.",
      "Place the vada in the pav and serve hot."
    ],
    nutrition: {
      calories: "320 kcal",
      protein: "6g",
